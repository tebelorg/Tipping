...
else
{
	...
	$_GET['SENDTO'] = "chua.celestine@gmail.com, kensoh@gmail.com"; // set to alert recipient
	$_GET['SENDFROM'] = "support@tebel.sg <support@tebel.sg>"; // set from
	$_GET['SUBJECT'] = "PersonalExcellence.co down"; // set subject for email alert
...
function sendmail_service() { // call mailer REST API to send email
	ob_start(); include('/home/olam/www/api/mailbot/mailer.php');
